      ...
      <nav className="navbar navbar-expand-md scrolled dark-navbar fixed-top">
        <div className="container-lg">
          <Link to="/" className="navbar-brand ps-0 ps-md-4">
            <img src={logoLight} className="brandImg" alt="" />
          </Link>
          <button
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ms-auto nav-links">
              <li className="nav-item pe-4">
                <Link
                  to="/productdetails"
                  class={`nav-link nav-border  ${
                    pathname === "/productdetails" && "active"
                  }`}
                >
                  Products Details
              ...
              <li className="nav-item pe-0 pe-md-4">
                ...
                >
                  {" "}
                  <span className="fw-semibold">Log</span>out
                </button>
              </li>
            </ul>
          </div>
